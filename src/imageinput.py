...
class ImageInput(obsobj.OBS_Object):
  ...
  def setup_modify_ui(self, gui : 'owg.OBS_WS_GUI') -> None:
    ...
    self.modify_url_label.grid(column = 0, row = 2, sticky = tk.W)
